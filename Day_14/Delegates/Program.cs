...
namespace DelegateAssignment
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            DelegateHandler.StringManipulationHandler handler = StringUtils.ReplaceByUnderscore;
            handler += StringUtils.ReverseString;

            DelegateHandler.StringManipulate(inputData, handler);
